...
\begin{document}
    ...
    \begin{onecolentry}
        ...
        \item Barratt-Priddy-Quillen type theorems
    ...
    \section{Publications}
        ...
        \begin{samepage}
            \begin{twocolentry}{
                ...
                \textbf{Polynomial functors from representations (to appear)}

                \vspace{0.10 cm}

                \mbox{Vladislav Romanovskii}, \mbox{\textbf{\textit{Artem Semidetnov}}}
            \end{twocolentry}
        \end{samepage}
        ...
        \begin{samepage}
            \begin{twocolentry}{
                ...
                \textbf{Operads from crossed simplicial groups}
    ...
    \section{Selected Talks}
        ...
        Aug 2025
            ...
            \textbf{\href{https://cs.hse.ru/mirror/pubs/share/1075346122}{"Plus construction and simplicial methods"}}
            \begin{highlights}
                \item \href{https://cs.hse.ru/ata-lab/atgcda25}{Conference "Algebraic Topology, geometry, combinatorics, and data analysis"}
            \end{highlights}
        \end{twocolentry}
    ...
    \begin{onecolentry}
        ...
        \item \href{https://eteam.tfjm.org/about-us-2025/}{A member of Scientific Organization Committee in ETEAM 2025}
