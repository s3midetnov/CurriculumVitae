...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}Geneve, Switzerland}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
    ...
    \section{Education}
        ...
        \begin{threecolentry}{\textbf{M.Sc}}{
            ...
            \textbf{Geneva University}, Mathematics
        \end{threecolentry}
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{Languages:} Python, Java, Kotlin, SQL, Haskell
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Technologies:} docker, PyTorch
        \end{onecolentry}
